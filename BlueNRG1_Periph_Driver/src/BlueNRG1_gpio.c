...
/**
* @brief  Set the retention state of the retained GPIO: IO9, IO10, IO11.
...
*         QFN32 package: 15 pins, WLCSP32 package: 14 pins, QFN48 package: 26.
* @retval None
*/
void GPIO_SetRetentionState(uint32_t GPIO_Pin, BitAction BitVal)
{
#ifdef BLUENRG2_DEVICE
  /* Check the parameters */
