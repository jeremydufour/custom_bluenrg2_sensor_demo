 ...
 *           from CMSIS SVD File 'BlueNRG2.svd' Version 1.1.0,
 *
 * @par      License
 *
 *******************************************************************************************************/
...
typedef struct {                                    /*!< GPIO Structure                                                        */
  ...
  union {
    __IO uint32_t  MODE1;                           /*!< Select mode for IO8 to IO15.<ul><li>000b: GPIO mode.</li><li>001b:
                                                         Serial1 mode.</li><li>100b: Serial0 mode.</li><li>101b: Microphone/ADC
                                                          mode.</li></ul>                                                      */
    ...
    struct {
      ...
      __IO uint32_t  IO14       :  3;               /*!< IO14 mode                                                             */
           uint32_t             :  1;
      __IO uint32_t  IO15       :  3;               /*!< IO15 mode                                                             */
    } MODE1_b;                                      /*!< BitSize                                                               */
  };
  
  union {
    __IO uint32_t  MODE2;                           /*!< Select mode for IO16 to IO23                                          */
    
    struct {
      __IO uint32_t  IO16       :  3;               /*!< IO16 mode                                                             */
           uint32_t             :  1;
      __IO uint32_t  IO17       :  3;               /*!< IO17 mode                                                             */
           uint32_t             :  1;
      __IO uint32_t  IO18       :  3;               /*!< IO18 mode                                                             */
           uint32_t             :  1;
      __IO uint32_t  IO19       :  3;               /*!< IO19 mode                                                             */
           uint32_t             :  1;
      __IO uint32_t  IO20       :  3;               /*!< IO20 mode                                                             */
           uint32_t             :  1;
      __IO uint32_t  IO21       :  3;               /*!< IO21 mode                                                             */
           uint32_t             :  1;
      __IO uint32_t  IO22       :  3;               /*!< IO22 mode                                                             */
           uint32_t             :  1;
      __IO uint32_t  IO23       :  3;               /*!< IO23 mode                                                             */
    } MODE2_b;                                      /*!< BitSize                                                               */
  };
  
  union {
    __IO uint16_t  MODE3;                           /*!< Select mode for IO24 to IO25                                          */
    
    struct {
      __IO uint16_t  IO24       :  3;               /*!< IO24 mode                                                             */
           uint16_t             :  1;
      __IO uint16_t  IO25       :  3;               /*!< IO25 mode                                                             */
    } MODE3_b;                                      /*!< BitSize                                                               */
  };
...
typedef struct {                                    /*!< FLASH Structure                                                       */
  ...
  __I  uint16_t  SIZE;                              /*!< Indicates the size of the main Flash                                  */
...
typedef struct {                                    /*!< SYSTEM_CTRL Structure                                                 */
  ...
  __IO uint8_t   SLEEPIO_OEN;                       /*!< IO output enable register for low power modes. It is 1 bit for
                                                         IO: bit0 for IO9, bit1 for IO10, bit2 for IO9.<ul><li>0: IO
                                                          output disabled.</li><li>1: IO output is enabled.</li></ul>          */
  __I  uint8_t   RESERVED3[3];
  __IO uint8_t   SLEEPIO_OUT;                       /*!< IO data output value register for low power modes. It is 1 bit
                                                         for IO: bit0 for IO9, bit1 for IO10, bit2 for IO9.<ul><li>0:
                                                          put the IO low.</li><li>1: put the IO high.</li></ul>                */
  __I  uint8_t   RESERVED4[3];
  __IO uint8_t   SLEEPIO_DS;                        /*!< IO drive strength control register for low power modes. It is
                                                         1 bit for IO: bit0 for IO9, bit1 for IO10, bit2 for IO9.<ul><li>0:
                                                          drive up to 2 mA.</li><li>1: drive up to 4 mA.</li></ul>             */
  __I  uint8_t   RESERVED5[3];
  __IO uint8_t   SLEEPIO_PE;                        /*!< IO pull enable register for low power modes. It is 1 bit for
                                                         IO: bit0 for IO9, bit1 for IO10, bit2 for IO9.<ul><li>0: pull
...
typedef struct {                                    /*!< SPI Structure                                                         */
  ...
  union {
    ...
    struct {
      ...
      __IO uint32_t  CSS        :  5;               /*!< Command Size Select (in MicroWire mode). (CSS+1) defines the
      ...
      __IO uint32_t  FRF        :  2;               /*!< Frame format.<ul><li>00b: Motorola SPI frame format.</li><li>10b:
  ...
  union {
    ...
    struct {
      ...
      __IO uint32_t  MWAIT      :  1;               /*!< MicroWire Wait Sate Bit Enable                                        */
...
typedef struct {                                    /*!< ADC Structure                                                         */
  ...
  union {
    ...
    struct {
      ...
      __IO uint32_t  REFSEL     :  2;               /*!< Set the VREF for single ended conversion:<ul><li>00b: 0.0V.</li><li>10b:
                                                         0.6V.</li></ul>                                                       */
      __IO uint32_t  OSR        :  2;               /*!< Set the ADC resolution:<ul><li>00b: Set the oversampling ratio
  ...
  union {
    __I  uint8_t   IRQRAW;                          /*!< IRQ status raw register                                               */
    
    struct {
      __I  uint8_t   ENDCAL     :  1;               /*!< 1: when the calibration is completed                                  */
           uint8_t              :  1;
      __I  uint8_t   EOC        :  1;               /*!< 1: when the conversion is completed                                   */
      __I  uint8_t   WDOG       :  1;               /*!< 1: when the data is inside the thresholds                             */
    } IRQRAW_b;                                     /*!< BitSize                                                               */
  };
  __I  uint8_t   RESERVED3[3];
  __I  uint16_t  DATA_CONV_LSB;                     /*!< Result of the conversion negligeble.                                  */
  __I  uint16_t  DATA_CONV;                         /*!< Result of the conversion in two complement format.                    */
...
typedef struct {                                    /*!< CKGEN_SOC Structure                                                   */
  ...
  union {
    ...
    struct {
      ...
      __IO uint32_t  PKA        :  2;               /*!< PKA AHB clock and RAM                                                 */
    } CLOCK_EN_b;                                   /*!< BitSize                                                               */
  };
  ...
  union {
    __I  uint32_t  JTAG_IDCODE;                     /*!< JTAG ID code                                                          */
    
    struct {
           uint32_t             :  1;
      __I  uint32_t  MANUF_ID   : 11;               /*!< Manufacturer ID                                                       */
      __I  uint32_t  PART_NUMBER: 16;               /*!< Part number                                                           */
      __I  uint32_t  VERSION_NUM:  4;               /*!< Version                                                               */
    } JTAG_IDCODE_b;                                /*!< BitSize                                                               */
  };
} CKGEN_SOC_Type;
...
typedef struct {                                    /*!< BLUE_CTRL Structure                                                   */
  __IO uint32_t  INTERRUPT;                         /*!< Interrupt status and clear register                                   */
  __IO uint32_t  TIMEOUT;                           /*!< Timeout programming register                                          */
  __I  uint32_t  TIMER_CAPTURE;                     /*!< Captured timer value register                                         */
  __IO uint32_t  RADIO_CONFIG;                      /*!< Radio configuration register                                          */
  __I  uint32_t  CURRENT_TIME;                      /*!< Timer current value register                                          */
  __I  uint32_t  STATUS;                            /*!< Status register                                                       */
  __IO uint32_t  AES_KEY0;                          /*!< AES key bit [127:96]                                                  */
  __IO uint32_t  AES_KEY1;                          /*!< AES key bit [95:64]                                                   */
  __IO uint32_t  AES_KEY2;                          /*!< AES key bit [63:32]                                                   */
  __IO uint32_t  AES_KEY3;                          /*!< AES key bit [31:0]                                                    */
  __IO uint32_t  CLEAR_TEXT0;                       /*!< AES clear text bit [127:96]                                           */
  __IO uint32_t  CLEAR_TEXT1;                       /*!< AES clear text bit [95:64]                                            */
  __IO uint32_t  CLEAR_TEXT2;                       /*!< AES clear text bit [63:32]                                            */
  __IO uint32_t  CLEAR_TEXT3;                       /*!< AES clear text bit [31:0]. Writing in this register starts an
                                                         encryption                                                            */
  __I  uint32_t  AES_CYPHERTEXT0;                   /*!< AES cypher text bit [127:96]                                          */
  __I  uint32_t  AES_CYPHERTEXT1;                   /*!< AES cypher text bit [95:64]                                           */
  __I  uint32_t  AES_CYPHERTEXT2;                   /*!< AES cypher text bit [63:32]                                           */
  __I  uint32_t  AES_CYPHERTEXT3;                   /*!< AES cypher text bit [31:0]                                            */
  __IO uint32_t  HOST_WKUP_TIMER;                   /*!< Host wakeup timer register                                            */
} BLUE_CTRL_Type;
...
typedef struct {                                    /*!< PKA Structure                                                         */
  ...
  union {
    __IO uint32_t  CSR;                             /*!< Command and status register                                           */
    
    struct {
      __O  uint32_t  GO         :  1;               /*!< PKA start processing command:<ul><li>0: has no effect.</li><li>1:
                                                         starts the processing.</li></ul>After this bitfield is written
                                                          to 1, it must be written back to zero manually.                      */
      __I  uint32_t  READY      :  1;               /*!< PKA readiness status:<ul><li>0: the PKA is computing. It is
                                                         ...
                                                         >The rising edge of the READY bit set the PROC_END flag in the
                                                          ISR register.                                                        */
           uint32_t             :  5;
      __O  uint32_t  SFT_RST    :  1;               /*!< PKA software reset:<ul><li>0: has no effect.</li><li>1: reset
  ...
  union {
    ...
    struct {
      __IO uint32_t  PROC_END   :  1;               /*!< PKA process ending interrupt. When read:<ul><li>0: no event.</li><li>1:
                                                         PKA process is ended.</li></ul>When written:<ul><li>0: no effect.</li><li>
                                                         1: clears the PKA process ending interrupt.</li></ul>                 */
           uint32_t             :  1;
      __IO uint32_t  RAM_ERR    :  1;               /*!< RAM read / write access error interrupt. When read:<ul><li>0:
      ...
      __IO uint32_t  ADD_ERR    :  1;               /*!< AHB address error interrupt. When read:<ul><li>0: All AHB read
  ...
  union {
    ...
    struct {
      __IO uint32_t  PROCEND_EN :  1;               /*!< Process ended interrupt enable.<ul><li>0: interrupt disabled.</li><li>1:
                                                         interrupt enabled.</li></ul>                                          */
           uint32_t             :  1;
      __IO uint32_t  RAMERR_EN  :  1;               /*!< RAM access error interrupt enable.<ul><li>0: interrupt disabled.</li><li>1
                                                         : interrupt enabled.</li></ul>                                        */
      __IO uint32_t  ADDERR_EN  :  1;               /*!< AHB address error interrupt enable.<ul><li>0: interrupt disabled.</li><li>
