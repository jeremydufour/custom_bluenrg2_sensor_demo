...
//#define SERVICE_MANAGER_SIZE       PAGE_SIZE_ROUND(66 * 1024)
#define SERVICE_MANAGER_SIZE       PAGE_SIZE_ROUND(86 * 1024) /* BLE stack v2.x ( LE Secure connections + PM + Privacy 1.2) */
