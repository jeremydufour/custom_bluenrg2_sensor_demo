...
*/
#define NEW_FIXED_BUFFER_SIZE_BYTES (5036) 
 ...
 */
#define DEFAULT_MAX_ATT_MTU             (158)
 ...
 */
#define PREP_WRITE_X_ATT(max_att)       DIV_CEIL(max_att, DEFAULT_ATT_MTU - 5)
 ...
 * [Vol 3, Part A]
 */
#define FRAG_X_MTU(mtu)	                DIV_CEIL((mtu) + 4, DEFAULT_ATT_MTU + 4)
 ...
 */
#define PCKT_MBLOCKS_C(pw, mtu, n_link) ((pw) + MAX((FRAG_X_MTU(mtu) * (1 + (n_link))), \
 ...
 */
#define DEFAULT_PCKT_COUNT              PCKT_MBLOCKS_C(DEFAULT_PREP_WRITE_LIST_SIZE,\
                                                       DEFAULT_MAX_ATT_MTU, NUM_LINKS)
...
#define TOTAL_BUFFER_SIZE(NUM_LINKS,NUM_GATT_ATTRIBUTES,NUM_GATT_SERVICES,ATT_VALUE_ARRAY_SIZE,PCKT_COUNT) (\
  NEW_FIXED_BUFFER_SIZE_BYTES + ((((ATT_VALUE_ARRAY_SIZE)-1)|3)+1) + \
  (300*NUM_LINKS) + \
